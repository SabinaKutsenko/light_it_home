...
function NotFound(props) {
	...
	const backgroundColor = light === 1 ? "#000000" : "#ffffff";

	return (
		<div style={{ flexDirection: 'column', backgroundColor }} styleName="content">
			<div styleName="notFoundPage">
				<div>
					<h1>Not Found Page</h1><br />
					<p>You changed name {count} times</p>
				</div>
